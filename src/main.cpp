...
int main() {
    int num_points = 6; // determine how many 3d points
    ...
    set_original = Eigen::MatrixXd::NullaryExpr(3,num_points,[&](){return dis(gen);});
